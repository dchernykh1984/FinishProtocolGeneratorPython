...
The app stores its files (race info, logs) next to the program, so a
downloaded portable build keeps everything beside the executable the user ran
the user ran. In development the behaviour is unchanged: data is resolved
against the current working directory, as the original relative paths were.
"""
